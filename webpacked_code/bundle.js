...
/***/ function(module, exports, __webpack_require__) {
	...
	var NinjaGold = React.createClass({
	  ...
	  handleFarmButtonClick(event) {
	    ...
	    var a = new Date();
	    a = a.toJSON();
	    this.state.msgarr.push(React.createElement(
	      'li',
	      { key: this.state.msgarr.length },
	      'Eared 15 golds from Farm! ',
	      a,
	      ' '
	    ));
	    // update information
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { onClick: this.handleFarmButtonClick },
	            'Find Gold!'
	          )
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { onClick: this.handleCaveButtonClick },
	            'Find Gold!'
	          )
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { onClick: this.handleHouseButtonClick },
	            'Find Gold!'
	          )
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { onClick: this.handleCasinoButtonClick },
	            'Find Gold!'
	          )
	        )
	      ),
	...
	var App = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(NinjaGold, null);
	  }
	});
